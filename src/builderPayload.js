export function buildBallotObject(contestTitle, mode, sortMode, allowExclusion, candidates, ballotOptions = {}) {
  ...
  return {
    ...
    completionRule: ballotOptions.completionRule || { mode: 'all-ranked' },
    completionLabel: ballotOptions.completionLabel || 'Copy results',
    ballotTheme: ballotOptions.ballotTheme || 'default',
